...
export default function Home() {
    ...
    return (
        <div className={isDark ? 'darkContainer' : 'container'}>
            <Head>
                <title>RUPT - Stories That’ll Help You Understand</title>
            ...
            <main className={styles.main}>
                <header className={styles.header}>
                    ...
                    <div onClick={toggleClass}><Image src="/light.png" alt="Rupt Logo" width={24} height={24} /></div>
                </header>
                <div className={styles.intro}>
                    <Image src="/purple-semi-circle.png" alt="Rupt Logo" width={400} height={150} />
                    <div>
                        <h2>Stories That’ll Help You Understand</h2>
                        <p>In 5 minutes, learn about what’s new in blockchain, web 3, crypto, NFTs, dApps, GameFi...and how they're changing the world.</p>
                    </div>
                </div>
                            ...
                            <form action="https://werupt.us5.list-manage.com/subscribe/post?u=9931b68204c3b60a1e832fc12&amp;id=1e1de041b0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className={`validate ${styles.subscribeForm}`} target="_blank" noValidate>
                                <div id="mc_embed_signup_scroll">
                                    <div className="mc-field-group">
                                        <input type="text" defaultValue="" name="FNAME" id="mce-FNAME" placeholder="Name"/>
                                    </div>
                                    <div className="mc-field-group">
                                        <input type="hidden" defaultValue="" name="LNAME" id="mce-LNAME" />
                                    </div>
                                    <div className="mc-field-group">
